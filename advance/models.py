...
class Advance(BaseModel):
    ...
    amount = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name="Pul miqdori"
    )
    comment = models.CharField(
        max_length=500, null=True, blank=True, verbose_name="Izoh"
    )
    is_settled = models.BooleanField(
        default=False, verbose_name="Hisoblanganmi", db_index=True
    )
    settled_amount = models.DecimalField(
        max_digits=12, decimal_places=2, default=0, verbose_name="Qolgan pul miqdori"
    )
    ...
    def __str__(self):
        ...
        return f"Deleted Employee - {self.amount} - {self.created_at}"
...
class Salary(BaseModel):
    ...
    def __str__(self):
        ...
        return f"Deleted Employee - {self.amount} - {self.comment}"